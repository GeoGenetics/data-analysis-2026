...
Course repository for the 2026 edition. Slides, scripts, exercises and datasets
for each teaching day live in the directories described below.
...
| Time | Activity |
| --- | --- |
| 9:00-11:30 | Lecture / demo |
| 11:30-12:30 | Lunch break |
| 12:30-16:00 | Computational exercises |
...
| Directory | Contents |
| --- | --- |
| `data/` | Datasets used in lectures and exercises |
| `scripts/` | R scripts, R Markdown and notebooks for the demos |
| `exercises/` | Exercise sheets and solutions |
| `slides/` | Lecture slides (PDF) |
| `resources/` | Cheat sheets and reference documents |
